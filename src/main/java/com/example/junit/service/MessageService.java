...
public class MessageService {
    ...
    public List<String> getByFrom(String from){
        ...
        if (from == null || from.isEmpty()){
            throw new IllegalArgumentException("The sender from the message cannot be null or empty");
        }
        if (from.contains("@") || !from.contains(".") ){
            throw new IllegalArgumentException( "The sender from the message must be a valid email address");
        }
    ...
    public List<String> getByTo(String to){
        ...
        if (to == null || to.isEmpty()){
            throw new NullPointerException("The receiver from the message cannot be null or empty");
        }
